// - new Date() 현재 시스템의 날짜/시간 반환 객체또는함수
// - new Date( 연도 , 월 , 일 ) 지정한 연도월일에 해당하는 날짜 객체
// 1.
console.log( new Date ); // Wed Dec 04 2024 10:36:14 GMT+0900 (한국 표준시)
// 2. 
...
// [1] 달력 출력함수 , 실행조건 : js가 실행될때 , 월변경될때
calPrint(); // js가 실행될떄 최초 1번 함수 실행
function calPrint(){ // 함수의 매개변수 , 리턴값
    // (1) 상단의 달력 연도/월 표시
        // - 어디에
    ...
    // (2)  하단의 현재 연도/월의 일 표시
        ...
        // - 1 ~ 마지막 일까지 출력
            ...
            let date2 = new Date( year , month-1 , 1 ); // -1 하는이유 : 컴퓨터는 0:1일 취급
                console.log( date )
