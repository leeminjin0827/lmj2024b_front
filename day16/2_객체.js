...
console.log( 영화정보.boxOfficeResult.weeklyBoxOfficeList ) // 주간 박스 오피스의 영화 정보 목록
console.log( 영화정보.boxOfficeResult.weeklyBoxOfficeList[1].rank ); // 주간 박스오피스의 2번째 영화 정보의 순위
console.log( 영화정보.boxOfficeResult.weeklyBoxOfficeList[1].movieNm ); // 주간 박스 오피스의 2번째 영화 정보의 영화명
...
for( let index = 0 ; index <= 영화정보.boxOfficeResult.weeklyBoxOfficeList.length -1 ; index++ ){
    // index는 0부터 주간 박스 오피스의 마지막 인덱스까지 1씩 증가 반복
    // index 번쨰의 영화 호출
