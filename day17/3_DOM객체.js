/* 
    객체 
        ...
        - 내가 만든 객체 vs 남이 만든 객체(라이브러리)
            남이 만든 객체 :
            1. console.log() / console객내체 log()함수 호출
            2. document.querySelector() / document객체내 querySelector()함수 호출
    *DOM객체*
        - JS 회사에서 미리 만들어진 HTML 관련 객체 제공 , 왜? JS에서HTML 조작하기 위해서
        - document 객체내 속성과 함수는 무엇이 있나요? 다양하다.
            1. document.write('출력할내용' )        : HTML에 출력할 내용을 출력햐주는 함수.
            2. document.querySelector('선택자')     : HTML에 지정한 선택자의 하나 마크업을 객체타입으로 반환 함수 [ 객체 ]
            3. document.querySelectorAll('선택자')  : HTML에 지정한 선택자의 모든 마크업을 객체타입으로 반환 함수 [ 배열 ]
                - 선택자( css통일 ) : 1.마크업 2..클래스명 3.#id명 4. >자식 5. 띄어쓰기 자손 등등
        ...
        - 요소(마크업) 객체 주요 속성/함수 , 마크업들의 속성들을 JS에서도 접근이 가능하다.
            ...
            2. .innerHTML : 지정된 마크업의 시작 마크업과 끝마크업의 > 사이 < 가 inner , 마크업 사이에[ HTML 호출/대입]
