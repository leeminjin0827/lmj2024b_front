/* 
    ...
    개발순서
        ...
        4. (JS) 기능/이벤트 구성 : 1.필요한 함수 기능 파악 2. 함수들이 실행되는조건 3. 각 함수들의 매개변수/리턴값
            - 1. 등록함수 : 실행조건 : [등록]버튼 클릭시 onclick                    , 매개변수 : x / 리턴값 : x
            - 1. 출력함수 : 실행조건 : 1.js실행될때 2.등록/수정/삭제가 성공했을때     , 매개변수 : x / 리턴값 : x
            - 1. 수정함수 : 실행조건 : [수정]버튼 클릭시 onclick                    , 매개변수 :  / 리턴값 : 
            - 1. 삭제함수 : 실행조건 : [삭제]버튼 클릭시 onclick                    , 매개변수 :  / 리턴값 : 
...
function 등록함수(){ // 등록버튼을 누를 때
    ...
    할일목록.push( 할일 );  // 생헝한 객체를 배열에 저장/대입
