/* 
    ...
    권장순서
        1. 저장할 데이터들을 수집 , 시장조사 , 기획
            - 갤러리명 , 게시물제목 , 글쓴이 , 작성일 , 조회 , 내용 , 게시물비밀번호 , 댓글비밀번호 , 댓글내용
        2.  중복을 최소화 할수 있는 데이터들을 관계별 분류
            - 갤러리 , 게시물 , 댓글
        3. 분류한 데이터들을 관계 연결 / 상하 관계 / 식별자 연결
    ...
    { 댓글번호 : 2 , 비밀번호 : 1234 , 내용 : "그래안녕1" , 게시물번호 : 1 }
    { 댓글번호 : 3 , 비밀번호 : 1234 , 내용 : "그래안녕1" , 게시물번호 : 3 }
    { 댓글번호 : 4 , 비밀번호 : 1234 , 내용 : "그래안녕1" , 게시물번호 : 4 }
*/
